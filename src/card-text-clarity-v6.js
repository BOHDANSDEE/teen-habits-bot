...
const PROBLEM_FIRST = Object.freeze([
  ...
  "Ти ввечері не залишаєш собі кілька хвилин, щоб спокійно завершити день",
  "Ти переходиш від активних справ до сну без звичного порядку",
  "Ти перед сном щоразу по-різному закінчуєш справи",
  "Ти часто лягаєш одразу після справ, не даючи собі часу переключитися",
  "Ти ввечері не маєш кількох простих кроків, які допомагають завершити справи",
  "Ти завершуєш вечір без зрозумілої послідовності перед сном",
  "Ти щоразу по-новому вирішуєш, як закінчити вечір",
  "Ти перед сном продовжуєш активні справи майже до останньої хвилини"
]);
...
const GAIN_BENEFIT = Object.freeze([
  "можеш не витрачати час на окрему підготовку до сну",
  "можеш займатися своїми справами майже до самого сну",
  "можеш не зупиняти вечірні справи заздалегідь",
  "можеш лягти спати одразу, коли вирішиш завершити день",
  "можеш не продумувати кілька кроків перед сном",
  "можеш довше залишатися в активному темпі ввечері",
  "можеш не витрачати вечір на однакові дії перед сном",
  "можеш завершувати вечір так, як зручно саме цього дня",
  "можеш не виділяти окремий час на підготовку до сну",
  "можеш не переривати цікаву справу завчасно",
  "можеш не дотримуватися одного порядку перед сном",
  "можеш довше не думати про те, що день уже треба завершувати",
  "можеш не зупиняти телефон, навчання чи інші справи в один час",
  "можеш переходити до сну без додаткових кроків",
  "можеш не готуватися до сну заздалегідь",
  "можеш продовжувати вечір, поки сам не вирішиш лягати",
  "можеш не витрачати сили на один вечірній порядок",
  "можеш щоразу завершувати день по-різному",
  "можеш не пам’ятати про кілька дій перед сном",
...
const MEANING_FIRST = Object.freeze([
  "Коли готуєшся до сну, кілька спокійних дій допомагають швидше перейти від справ до відпочинку",
  "Коли готуєшся до сну, простий порядок допомагає вчасно завершити активний день",
  "Коли готуєшся до сну, зрозуміле завершення вечора допомагає відпустити денні справи",
  "Коли готуєшся до сну, спокійна підготовка допомагає не переносити денний темп у ліжко",
  "Коли готуєшся до сну, кілька знайомих кроків роблять завершення дня простішим",
  "Коли готуєшся до сну, коротка послідовність допомагає вчасно зупинити справи",
  "Коли готуєшся до сну, зрозумілий порядок допомагає не починати ще одну справу",
  "Коли готуєшся до сну, коротка підготовка відділяє час справ від часу відпочинку",
  "Коли готуєшся до сну, кілька простих кроків допомагають завершувати вечір спокійніше",
  "Коли готуєшся до сну, кілька хвилин спокою допомагають легше перейти до відпочинку"
]);
