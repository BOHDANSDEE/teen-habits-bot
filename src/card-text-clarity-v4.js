...
const GENERIC_REASONS = Object.freeze([
  "користь є зараз, а зміна — потім",
  "зараз легше, а зміну можна відкласти",
  "полегшення є зараз, а крок — потім",
  "користь приходить одразу, а зміна чекає",
  "зараз простіше, а зміну можна відкласти",
  "полегшення є одразу, зміна — пізніше",
  "користь видно зараз, наслідки — потім",
  "зараз зручніше, а нова дія зачекає",
  "полегшення швидке, тому спосіб тримається",
  "зараз легше, навіть якщо потім заважає",
  "користь є одразу, тому міняти не хочеться",
  "зараз допомагає, а зміна потребує сил",
  "щось корисне є зараз, а зміна зачекає",
  "легше зараз, а новий крок можна відкласти",
  "користь приходить зараз, зміна — потім",
  "зараз простіше, тому спосіб легко зберегти",
  "користь є зараз, а нове можна спробувати потім",
  "цей спосіб полегшує момент, зміна зачекає",
  "зараз зручніше, а мінуси видно пізніше",
  "полегшення є одразу, а зміна може зачекати"
]);

const GOALS_MANY_REASONS = Object.freeze([
  "нова ціль цікава одразу, а головну можна не обирати",
  "можна знову захопитися новим, не звужуючи список цілей",
  ...
  "цікавість є одразу, а звужувати список цілей можна пізніше",
