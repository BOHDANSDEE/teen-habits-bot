...
Обери рівень. Тут 10 рівнів, синхронізованих із 10 темами статей цього розділу.`,
...
Для кожної підтеми є по 100 варіантів стану, проблеми, вторинної вигоди, значення в житті та афірмації.`,
      { reply_markup: mainMenuKeyboard() }
    );
    return;
  }
