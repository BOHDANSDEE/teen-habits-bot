...
const PHYSICAL_RELIEF = /легш|слабш|м’якш|м'якш|розслаб|вільніш|тепліш|спокійніш|менше|відпочил|розтис|вирівнял/iu;
const POSITIVE_EMOTION = /полегшення|радіст|настрій|спокою|задоволення|позитив|щастя|приємн|впевнен|краще/iu;
